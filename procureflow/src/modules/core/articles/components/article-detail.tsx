...
import { ArticleAliasForm } from './article-alias-form'
import { ArticlePriceDialog } from './article-price-dialog'
import { ArticleStockPanel } from './article-stock-panel'
import { ALIAS_TYPE_CONFIG, PRICE_SOURCE_CONFIG } from '../constants'
import type { AliasTypeKey, PriceSourceKey } from '../constants'
